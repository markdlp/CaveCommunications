...
\tableofcontents
\begin{multicols*}{2}\input{Introduction}\input{RelatedWorks}\end{multicols*}
\include{BibCompareTable}
\begin{multicols*}{2}\input{Conclusions}\input{Discussion}\printbibliography\end{multicols*}
